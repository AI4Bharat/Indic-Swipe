# -*- coding: utf-8 -*-
"""Gesture path generation-Tamil

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1wvR3T6lME1uyZZdmLakBqhVoxmidgRwh
"""
...
data = pd.DataFrame(list(set(data_list)), columns=['indic'])
...
# valid_chars_dict = {list_of_all_valid_chars[i]:i for i in range(len(list_of_all_valid_chars)) if not list_of_all_valid_chars[i] in valid_chars_dict} 
# valid_chars_dict['<e>'] = len(va)
