# -*- coding: utf-8 -*-
"""CTC+Spell Correct - Tamil

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ezvyr9_-Mwzlp5qi6IoGsD5CKOLu9cu1
"""
...
#             y=np.zeros(TRAIN_SIZE), batch_size=256, epochs=18) 
# network.model_train.save_weights(path+'/transformer_ctc_weights_stored')

network.model_train.load_weights(path+'/transformer_ctc_weights_stored')
...
#   print("Prediction :", [j for j in pred[i] if j!=-1], " -- Label : ", target_texts[TRAIN_SIZE+i]) 
...
len(pred_list_sep), len(corr_list_sep)
...
len(pred_list_sep), len(corr_list_sep_unique)
